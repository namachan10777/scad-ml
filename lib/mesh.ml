...
(* TODO: now that there is nothing else in here, it feels a bit silly to have
    the round extrude module with the spec and sweeps. It is true that I want
    to be able to do the extrusions of text, which should probably not depend
    on the top Mesh module.
